...
const outstandingStudentUrl = "https://sist.stdu.edu.cn/tzgg/xin-xi-ke-xue-yu-ji-shu-xue-yuan2023-2024xue-nian-yuan-ji-xian-jin-ping-xuan-tui-jian-jie-guo-gong-shi";
...
const youthLeagueHonorsUrl = "https://sist.stdu.edu.cn/tzgg/guan-yu2024-2025nian-du-xiao-ji-wu-si-biao-zhang-hou-xuan-ren-shang-bao-ming-dan-de-gong-shi";
...
export const honors: Honor[] = [
  ...
  { id: "outstanding-league-member", name: "五四优秀团员", date: "2025", level: "校级", officialUrl: youthLeagueHonorsUrl },
  { id: "outstanding-student", name: "三好学生", date: "2024", level: "院级", officialUrl: outstandingStudentUrl },
  { id: "class-monitor", name: "信2301-4班班长", date: "本科期间", level: "学生工作", description: "负责班级建设、日常管理与活动组织", proof: { type: "image", path: "/proofs/honors/class-monitor-proof.png" } },
