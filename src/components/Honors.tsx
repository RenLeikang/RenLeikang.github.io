            ...
            <div>
              <div className="flex flex-wrap items-center gap-2">
                <h3 className="text-[15px] font-semibold text-slate-900 dark:text-white">
                  {honor.officialUrl ? (
                    <a href={honor.officialUrl} target="_blank" rel="noreferrer" title="查看信息学院官网公示" className="focus-ring link-academic inline-flex items-center gap-1 rounded">
                      {honor.name}<ExternalLink size={12} aria-hidden="true" />
                    </a>
                  ) : honor.name}
                </h3>
                <span className="text-xs text-slate-400">{honor.date}</span>
              </div>
