  ...
  return (
    <section id="home" className="flex min-h-[70vh] items-center border-b border-slate-200/80 bg-slate-50/55 pt-16 dark:border-slate-800 dark:bg-slate-950">
      <div className="site-container grid gap-10 py-12 sm:py-14 md:grid-cols-[minmax(0,1fr)_270px] md:items-center lg:grid-cols-[minmax(0,1fr)_285px]">
        <div>
          <p className="mb-4 text-[13px] font-medium text-academic-600 dark:text-blue-400">个人学术主页</p>
          ...
          <div className="mt-6 flex flex-wrap gap-2.5">
            ...
            <a href={githubReady ? profile.github : "#contact"} target={githubReady ? "_blank" : undefined} rel="noreferrer" className="focus-ring inline-flex items-center gap-2 rounded-md border border-slate-300 bg-white px-4 py-2 text-sm font-medium text-slate-700 transition hover:border-academic-600 hover:text-academic-600 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-200 dark:hover:border-blue-400 dark:hover:text-blue-400"><Github size={16} />GitHub</a>
        ...
        <div className="mx-auto w-full max-w-[220px] sm:max-w-[235px] md:max-w-none">
          ...
          <p className="mt-3 text-center text-xs text-slate-400">计算机视觉 · 智能感知</p>
        </div>
      </div>
    </section>
  );
